    ...
    <div class="table-responsive">
        ...
        <nav aria-label="Page navigation example" class="mt-4">
            <ul class="pagination gap-2">
                <li class="btn btn-dark btn-sm"><a class="text-white" href="{{ route('specialists.index', ['page' => ($specialists->currentPage()-1)]) }}">Anterior</a></li>
                ...
                @endfor
                <li class="btn btn-dark btn-sm"><a class="text-white" href="{{ route('specialists.index', ['page' => ($specialists->currentPage()+1)]) }}">Siguiente</a></li>
            </ul>
        </nav>
    </div>
    </div>
