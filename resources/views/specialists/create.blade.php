...
@section('content')
    ...
    <form method="POST" action="{{ route('specialists.store') }}" class="row flex-column flex-md-row" enctype="multipart/form-data">
        @csrf
        @method('POST')
        <div class="col-12 col-md-6">
            ...
            <div class="form-group my-2">
                ...
                <select class="form-control @error('sex') is-invalid @enderror" id="sex" name="sex">
                    <option value="M" class="{{ old('sex') == "M" ? 'selected': ''}}">Masculino</option>
                    <option value="F" class="{{ old('sex') == "F" ? 'selected': ''}}">Femenino</option>
                    <option value="O" class="{{ old('sex') == "O" ? 'selected': ''}}">Otro</option>
                </select>
                @error('sex')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group my-2">
                ...
                <select class="form-control @error('type_document') is-invalid @enderror" id="type_document" name="type_document">
                    <option value="DNI" class="{{ old('type_document') == "DNI" ? 'selected': ''}}">DNI</option>
                    <option value="PASSPORT" class="{{ old('type_document') == "PASSPORT" ? 'selected': ''}}">Pasaporte</option>
                </select>
                @error('type_document')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group my-2">
                ...
                <input type="number" class="form-control @error('document_id') is-invalid @enderror" id="document_id" name="document_id" value={{ old('document_id') }}>
                @error('document_id')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="col-12 col-md-6">
            <div class="form-group my-2">
                ...
                <input type="number" min="0" max="5" class="form-control @error('evaluated_rate') is-invalid @enderror" id="evaluated_rate" name="evaluated_rate" value={{old('evaluated_rate')}}>
            ...
            <div class="d-flex justify-content-start my-4">
                <button type="submit" class="btn btn-dark w-auto">Crear Especialista</button>
            </div>
        </div>
    </form>
    </div>
