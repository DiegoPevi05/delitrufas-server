    ...
    <div class="table-responsive">
        <table class="table table-vcenter">
            ...
            @foreach ($meethistories as $meethistory)
                <tr>
                    ...
                    @endif
                    <td>
                        <div class="btn-group btn-group-sm flex row gap-2" role="group">
        ...
        <nav aria-label="Page navigation example" class="mt-4">
            <ul class="pagination gap-2">
                <li class="btn btn-dark btn-sm"><a class="text-white" href="{{ route('meethistories.index', ['page' => ($meethistories->currentPage()-1)]) }}">Anterior</a></li>
                ...
                @endfor
                <li class="btn btn-dark btn-sm"><a class="text-white" href="{{ route('meethistories.index', ['page' => ($meethistories->currentPage()+1)]) }}">Siguiente</a></li>
            </ul>
        </nav>
    </div>
