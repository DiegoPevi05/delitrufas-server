...
class AdminSpecialistTimesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('specialiststimes.index')->with('logSuccess', 'Tiempo de Especialista creado exitosamente.');
    ...
    public function update(Request $request, SpecialistTimes $specialiststime)
    {
        ...
        return redirect()->route('specialiststimes.index')->with('logSuccess', 'Tiempo de Especialista actualizado exitosamente.');
    }
    ...
    public function destroy(SpecialistTimes $specialiststime)
    {
        ...
        return redirect()->route('specialiststimes.index')->with('logSuccess', 'Tiempo de Especialista borrado exitosamente.');
    }
}
