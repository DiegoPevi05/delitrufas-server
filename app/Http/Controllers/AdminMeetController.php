...
class AdminMeetController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(!isset($validatedData['link_meet']) || !$validatedData['link_meet']){
            ...
            if($response_generate_link['status']){
                ...
                return redirect()->route('meets.create')->with('logError', $response_generate_link['message']);
            }
        }
        ...
        return redirect()->route('meets.index')->with('logSuccess', 'Reunion creada exitosamente.');
    ...
    public function update(Request $request, Meet $meet)
    {
        ...
        if(!isset($validatedData['link_meet']) || !$validatedData['link_meet']){
            ...
            if($response_generate_link['status']){
                ...
                return redirect()->route('meets.edit',$meet)->with('logError', $response_generate_link['message']);
            }
        }
    ...
    public function destroy(Meet $meet)
    {
        ...
        return redirect()->route('meets.index')->with('logSuccess', 'Reunion borrada exitosamente.');
    }
    ...
    public function notifyUser(Meet $meet){
        ...
        try{
            ...
            return redirect()->route('meets.index')->with('logError', 'Hubo un error notificando al usuario, intenta en un rato.');
        }
    ...
    public function notifySpecialist(Meet $meet){
        ...
        try{
            ...
            return redirect()->route('meets.index')->with('logError', 'Hubo un error notificando al especialista, intenta en un rato.');
        }
    ...
    public function getPaymentStatus(Meet $meet){
        ...
        if($response_validatepayment['status']){
            ...
            return redirect()->route('meets.index')->with('logSuccess', $response_validatepayment['payment_message']);

        }else{
            return redirect()->route('meets.index')->with('logError',$response_validatepayment['payment_message']);
        }
    }
