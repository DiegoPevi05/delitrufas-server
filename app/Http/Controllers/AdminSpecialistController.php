...
class AdminSpecialistController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('specialists.index')->with('logSuccess', 'Especialista creado exitosamente.');
    ...
    public function update(Request $request, Specialist $specialist)
    {
        ...
        return redirect()->route('specialists.index')->with('logSuccess', 'Especialista actualizado exitosamente.');
    }
    ...
    public function destroy(Specialist $specialist)
    {
        ...
        return redirect()->route('specialists.index')->with('logSuccess', 'Especialista borrado exitosamente.');
    }
}
